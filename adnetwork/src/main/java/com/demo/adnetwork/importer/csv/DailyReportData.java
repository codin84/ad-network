...
public class DailyReportData {
    ...
    public DailyReportData(@Nonnull final LocalDate date,
                           @Nonnull final String app,
                           @Nonnull final String platform,
                           @Nonnull final String requests,
                           @Nonnull final String impressions,
                           @Nonnull final String revenue,
